...
function ellectangle(x, y, r, r2) {
  noFill();
  rect(x - r / 2, y - r2 / 2, r, r2);
  ellipse(x, y, r, r2);
}

function ellectangle(x, y, r, r2, c1, c2, c3, c4, c5, c6) {
  stroke(c1, c2, c3);
  rect(x - r / 2, y - r2 / 2, r, r2);
  stroke(c4, c5, c6);
  ellipse(x, y, r, r2);
}
function ellectangle(x, y, r, r2, c1, c2, c3) {
  stroke(c1, c2, c3);
  rect(x - r / 2, y - r2 / 2, r, r2);
  ellipse(x, y, r, r2);
}
function triectangle(x, y, r) {
